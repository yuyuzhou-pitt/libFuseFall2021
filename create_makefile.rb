...
CMOCK_DIR = File.expand_path(ENV.fetch('CMOCK_DIR', File.join(ABS_ROOT, './CMockCopy')))
...
TEST_MAKEFILE = ENV.fetch('TEST_MAKEFILE', File.join(ABS_ROOT, 'MakefileTestSupport'))
